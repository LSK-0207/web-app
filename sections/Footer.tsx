    ...
    >
      ...
      <div className="max-w-7xl flex flex-col md:flex-row mx-auto h-full items-center text-white">
        ...
        <div className="w-full md:w-2/5 font-serif flex flex-col md:flex-row items-center md:items-start justify-center md:justify-around text-center md:text-left gap-8 md:gap-4">
          ...
          <div className="flex flex-col items-center md:items-start"> {/* Align text left on medium*/}
            <div className="py-3">
          ...
          {/* Quick Links */}
          <div className="flex flex-col items-center md:items-start justify-center text-xl"> {/* Align text left on medium */}
            <ul>
              <li className="py-2 sm:py-3">Home</li>
              <li>About</li>
            </ul>
          </div>
        </div>
